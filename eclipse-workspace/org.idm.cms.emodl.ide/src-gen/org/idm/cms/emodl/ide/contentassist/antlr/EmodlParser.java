...
public class EmodlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, EmodlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getEModelAccess().getGroup(), "rule__EModel__Group__0");
			...
			builder.put(grammarAccess.getEndModelAccess().getGroup(), "rule__EndModel__Group__0");
			...
			builder.put(grammarAccess.getEModelAccess().getImportsAssignment_0(), "rule__EModel__ImportsAssignment_0");
			builder.put(grammarAccess.getEModelAccess().getStartModelAssignment_1(), "rule__EModel__StartModelAssignment_1");
			builder.put(grammarAccess.getEModelAccess().getElementsAssignment_2(), "rule__EModel__ElementsAssignment_2");
			builder.put(grammarAccess.getEModelAccess().getEndModelAssignment_3(), "rule__EModel__EndModelAssignment_3");
			...
			builder.put(grammarAccess.getEndModelAccess().getNameAssignment_2(), "rule__EndModel__NameAssignment_2");
